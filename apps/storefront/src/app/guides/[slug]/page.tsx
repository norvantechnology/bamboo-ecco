...
export default async function GuideArticlePage({ params }: Props) {
  ...
  return (
    <article className="container-page max-w-4xl lg:max-w-5xl py-10 sm:py-14">
      ...
      />
      <Link href="/guides" className="text-xs font-bold uppercase tracking-wider text-[#b8863a] hover:underline">← Back to Guides</Link>
      ...
      {featuredProducts.length > 0 && (
        <div className="mt-12 pt-8 border-t border-border/80">
          <div className="flex items-center justify-between gap-3 mb-6">
            <div>
              <span className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#b8863a]">Handcrafted Excellence</span>
              <h3 className="font-display text-xl sm:text-2xl font-semibold text-foreground mt-1">Recommended Artisan Products</h3>
            </div>
      ...
      <div className="mt-10 rounded-2xl border border-border/80 bg-surface/80 p-6 sm:p-8 shadow-warm">
        ...
        <p className="mt-1.5 text-xs sm:text-sm text-muted">Explore handcrafted bamboo home products curated by artisans across Northeast India.</p>
