...
const DEFAULT_HOMEPAGE_FALLBACK: HomepageData = {
  ...
  sections: {
    ...
    impact: { enabled: true, label: "Our Impact", title: "Preserving Tripura's Bamboo Lineage", description: "Rooted in the lush hills of Tripura" },
    ...
    artisansTeaser: { enabled: true, label: "Artisan Heritage", title: "Meet the Weavers of Agartala", description: "Discover the real people behind every piece" },
