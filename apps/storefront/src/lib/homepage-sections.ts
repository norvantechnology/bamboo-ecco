...
export const DEFAULT_HOMEPAGE_SECTIONS: HomepageSections = {
  ...
  newArrivals: { enabled: true, label: "Just landed", title: "New Bamboo Decor & Furniture", description: "Fresh handcrafted bamboo pieces — just added to our online store", href: "/new-arrivals", limit: 4 },
  bestSellers: { enabled: true, label: "Popular", title: "Best-Selling Bamboo Home Decor", description: "Our most-loved sustainable furniture and decor, chosen by customers across India", href: "/best-sellers", limit: 8 },
  whyChooseUs: { enabled: true, label: "Our promise", title: "Why Choose Terra Living Bamboo Furniture" },
